...
<p align="center"><sub>
  ...
  written. The survey-geometry panels and the reduced-time figure are the exception: they are still generated by
  <a href="docs/manual/fixtures.mjs"><code>docs/manual/fixtures.mjs</code></a> at an obviously artificial origin,
  because geometry is coordinates by definition and because these records carry no offset header.
</sub></p>
