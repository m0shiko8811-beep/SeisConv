...
<p align="center"><sub>
  <b>Every figure below is synthetic.</b> Each one is captured by driving the built application over a
  deterministic, seeded SEG-Y set generated by <a href="docs/manual/fixtures.mjs"><code>docs/manual/fixtures.mjs</code></a>
  at an obviously artificial origin, and checked against a forbidden-token denylist before it is written.
  No real survey, station, coordinate or client name appears anywhere in this repository.
</sub></p>
