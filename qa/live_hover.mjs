...
//
// Uses a sample paired SEG-Y + SPS dataset. Runs headed
...
import { launch, mockDialogs, gotoTab, openFile, loadSps, shot, sleep } from './harness.mjs';

const SEGY = process.env.HOVER_SEGY
  || './samples/example.segy';
