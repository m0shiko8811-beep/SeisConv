...
//   no default; point it at a local SPS dataset directory (e.g. an ITM / EPSG:2039 survey)
//   env      SEISCONV_SPS_DIR + SEISCONV_SPS_BASE point at any other triplet (e.g. a UTM 36N line).
//
// Run:
//   npx tsx scripts/positioning-qc.ts        (from the repo root)
//   SEISCONV_SPS_DIR="D:/path/to/sps" SEISCONV_SPS_BASE=<triplet-basename> npx tsx scripts/positioning-qc.ts
//
