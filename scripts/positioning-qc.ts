...
//   default  ./samples/sps  (a sample S/R/X triplet; ITM / EPSG:2039)
//   env      SEISCONV_SPS_DIR + SEISCONV_SPS_BASE point at any other triplet.
//
// Run:
//   npx tsx scripts/positioning-qc.ts        (from the repo root)
//   SEISCONV_SPS_DIR="/path/to/your/sps" SEISCONV_SPS_BASE=SURVEY npx tsx scripts/positioning-qc.ts
//
...
// -- Config: default to a local ./samples triplet; override via env. --
const DEFAULT_DIR = './samples/sps';
